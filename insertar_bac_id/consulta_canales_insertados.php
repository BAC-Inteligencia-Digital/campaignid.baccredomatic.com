<?php
   ...
   if ($conexion and !$canal1_seleccionado=="0")
   {
   ...
   if ($conexion and !$canal2_seleccionado=="0")
   {
   ...
   if ($conexion and !$canal3_seleccionado=="0")
   {
   ...
   if ($conexion and !$canal4_seleccionado=="0")
   {
   ...
   if ($conexion and !$canal5_seleccionado=="0")
   {
   ...
   if ($conexion and !$canal6_seleccionado=="0")
   {
