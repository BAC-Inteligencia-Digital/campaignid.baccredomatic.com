<?php
    ...
    if ($nombre_pais == 'REG'){
        ...
        // establecer y realizar consulta. guardamos en variable.
        $consulta = "select * from (
            select a.id,a.nombre_bac_id, a.fecha_creacion,a.nombre_campana, b.nombre as nombre_pais,b.abreviatura as abreviatura_pais, c.nombre_origen, d.nombre_categoria, e.nombre_producto from bac_id_generados as a
                join pais as b
                on b.abreviatura = substring(a.nombre_bac_id,1,3)
                join origen_clientes as c
                on c.codigo = substring(a.nombre_bac_id,4,1)
                ...
                on e.codigo = substring(a.nombre_bac_id,11,3)
                union all
                select a.id,a.nombre_bac_id, a.fecha_creacion,a.nombre_campana, b.nombre as nombre_pais,b.abreviatura as abreviatura_pais, c.nombre_origen, d.nombre_categoria, GROUP_CONCAT('[',e.nombre_campana,']') as nombre_producto from bac_id_generados as a
                    join pais as b
                    on b.abreviatura = substring(a.nombre_bac_id,1,3)
                    join origen_clientes as c
                    on c.codigo = substring(a.nombre_bac_id,4,1)
            ...
            where tt.abreviatura_pais = '$nombre_pais'
            order by tt.fecha_creacion desc";
